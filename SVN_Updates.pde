...
//
// WEEK 5:
//        - Aisling added the heat map
//        - Laura removed the splash screen and changed how cases are saved
//        - Anton fixed a couple of bugs relating to the scrollbar
//        - Liam worked on the report
